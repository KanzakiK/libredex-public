    ...
    public void start() throws YieldException {
        ...
        try {
            ...
            File downloadLogFile = new File(android.os.Environment.getExternalStoragePublicDirectory(
                    android.os.Environment.DIRECTORY_DOWNLOADS), "libredex_logcat.log");
            ...
            File cacheCopyFile = new File(cacheDir, "libredex_logcat.log");
            ...
            Toast.makeText(State.getContext(), "请检查下载目录下是否导出了 'libredex_logcat.log' 这个文件", Toast.LENGTH_LONG).show();
