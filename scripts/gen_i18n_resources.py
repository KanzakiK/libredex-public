...
EXTRA = [
    ...
    ("guide_page_title_environment", "Root / Shizuku", "Root / Shizuku"),
    ("guide_page_title_permissions", "Overlay / Recording", "悬浮窗 / 录音"),
    ("guide_page_title_recording", "Recording", "录音"),
    ("guide_page_title_files", "File access · Screen capture", "文件访问 · 屏幕采集"),
    ...
    ("debug_moonlight_handshake_label", "Moonlight handshake info", "Moonlight 握手信息"),
    ("debug_copied_handshake", "Handshake info copied", "已复制握手信息"),
    ("debug_no_control_input", "No recent Moonlight control input stats", "尚无最近一次 Moonlight 控制输入统计"),
    ("debug_moonlight_control_label", "Moonlight control input stats", "Moonlight 控制输入统计"),
    ("debug_copied_control", "Control input stats copied", "已复制控制输入统计"),
    ("dex_pick_wallpaper", "Pick DeX wallpaper", "选择 DeX 壁纸"),
    ("dex_wallpaper_connect_dex", "Connect DeX first", "请先连接 DeX"),
    ("dex_wallpaper_display_missing", "DeX display not found", "DeX display 不存在"),
    ("dex_wallpaper_changed", "DeX wallpaper changed", "DeX 壁纸已更换"),
    ("screen_no_displays", "No displays found", "未发现可用屏幕"),
    ("screen_title_fmt", "Screen %1$d - %2$s", "屏幕 %1$d - %2$s"),
    ("screen_internal_viewonly", "The built-in screen is view-only; modify buttons are disabled to avoid changing system display parameters.", "内置屏幕仅允许查看，修改按钮已禁用，避免误改系统显示参数。"),
    ("screen_action_resolution", "Change resolution", "改分辨率"),
    ("screen_action_dpi", "Change DPI", "改 DPI"),
    ("screen_action_refresh_mode", "Refresh mode", "刷新模式"),
    ("screen_action_rotation", "Rotation", "旋转"),
    ("screen_info_current_size", "Current size: ", "当前尺寸: "),
    ("screen_info_refresh_rate", "Refresh rate: ", "刷新率: "),
    ("screen_info_current_mode", "Current mode: ", "当前模式: "),
    ("screen_info_mode_id", " (ID %1$d)", " (ID %1$d)"),
    ("screen_info_rotation", "Rotation: ", "旋转: "),
    ("screen_info_state", "State: ", "状态: "),
    ("screen_state_on", "On", "开启"),
    ("screen_info_base_size", "\\nBase size: ", "\\n基础尺寸: "),
    ("screen_info_initial_size", "\\nInitial size: ", "\\n初始尺寸: "),
    ("screen_info_rotation_frozen", "\\nRotation locked: ", "\\n旋转锁定: "),
    ("screen_yes", "Yes", "是"),
    ("screen_no", "No", "否"),
    ("screen_info_default_mode", "\\nDefault mode ID: ", "\\n默认模式ID: "),
    ("screen_info_user_mode", "\\nUser mode ID: ", "\\n用户模式ID: "),
    ("screen_info_read_failed", "\\nSystem-level info read failed: ", "\\n系统级信息读取失败: "),
    ("screen_confirm_dpi", "Confirm DPI", "确认 DPI"),
    ("screen_confirm_dpi_msg_fmt", "Keep the new DPI %2$d for screen %1$d? It reverts if not confirmed within 5 s.", "保留屏幕 %1$d 的新 DPI %2$d？5 秒内未确认会恢复。"),
    ("screen_use_system_default", "Use system default", "使用系统默认"),
